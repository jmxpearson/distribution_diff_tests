...
$julia laplace_types.jl > results/laplace_type_test_results.txt
...
#$julia vonmises_types.jl > results/vonmises_type_test_results.txt
$julia weibull_types.jl > results/weibull_type_test_results.txt

# discrete functions
$julia bernoulli_types.jl > results/bernoulli_type_test_results.txt
$julia betabinomial_types.jl > results/betabinomial_type_test_results.txt
